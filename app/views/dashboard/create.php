...
// Convert platforms to a map for Alpine.js
$platformsMap = [];
foreach ($musicPlatforms as $platform) {
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <input type="url" id="spotify_url" name="spotify_url" required 
                               ...
                               x-on:input="resetMetadata()">
                        <button type="button" 
                                class="btn btn-primary"
                                x-on:click="extractMetadata()">
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" id="autoSearch" x-model="autoSearch">
